...
public class LoungeChairBlock extends HorizontalFacingMountableBlock {
   public static final class_265 SHAPE = class_2248.method_9541(0.0, 0.0, 0.0, 16.0, 11.0, 16.0);

   public LoungeChairBlock(class_2251 settings) {
      super(settings);
   }
