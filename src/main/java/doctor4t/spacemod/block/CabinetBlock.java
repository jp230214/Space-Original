...
public class CabinetBlock extends class_2383 implements class_2343 {
   public static final class_2746 OPEN = class_2741.field_12537;

   public CabinetBlock(class_2251 settings) {
      super(settings);
      this.method_9590((class_2680)((class_2680)super.method_9564().method_11657(field_11177, class_2350.field_11043)).method_11657(OPEN, false));
   }

   @Nullable
   public class_3908 method_17454(class_2680 state, class_1937 world, class_2338 pos) {
      return (class_3908)world.method_35230(pos, SpaceModBlockEntities.CABINET).orElse(null);
   }

   @Nullable
   public class_2680 method_9605(class_1750 ctx) {
      return (class_2680)this.method_9564().method_11657(field_11177, ctx.method_8042().method_10153());
   }
   ...
   public void method_9588(class_2680 state, class_3218 world, class_2338 pos, class_5819 random) {
      world.method_35230(pos, SpaceModBlockEntities.CABINET).ifPresent(OpenableContainerBlockEntity::tick);
   }
   ...
   protected void method_9515(class_2690<class_2248, class_2680> builder) {
      builder.method_11667(new class_2769[]{OPEN, field_11177});
   }

   @Nullable
   public class_2586 method_10123(class_2338 pos, class_2680 state) {
      return SpaceModBlockEntities.CABINET.method_11032(pos, state);
   }
