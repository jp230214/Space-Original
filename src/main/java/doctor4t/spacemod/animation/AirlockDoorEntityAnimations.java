...
public class AirlockDoorEntityAnimations {
      ...
      .method_41820(
         ...
         new class_7179(
            ...
            new class_7186[]{
               ...
               new class_7186(0.7F, class_7187.method_41823(0.0F, -79.99F, 0.0F), Interpolations.EASE_OUT_EXPO)
            }
         )
      )
      .method_41821();
   public static final class_7184 CLOSE = class_7185.method_41818(1.0F)
      .method_41820(
         ...
         new class_7179(
            class_7183.field_37886,
            new class_7186[]{
               new class_7186(0.1F, class_7187.method_41823(0.0F, -79.99F, 0.0F), Interpolations.EASE_OUT_EXPO),
