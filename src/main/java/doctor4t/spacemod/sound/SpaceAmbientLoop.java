...
public class SpaceAmbientLoop extends class_1101 {
   private static final int TRANSITION_TIME = 40;
   private final class_746 player;
   private int transitionTimer;

   public SpaceAmbientLoop(class_746 player) {
      super(SpaceModSounds.AMBIENT_SPACE, class_3419.field_15256, class_1113.method_43221());
      this.player = player;
   ...
   public void method_16896() {
      if (!this.player.method_31481() && this.transitionTimer >= 0) {
         ...
         if (playerSpaceComponent.isInSpace()) {
            if (SpaceModClient.spaceTimer >= 40.0F) {
